...
<html lang="pt-br">
  ...
  <body class="p-3 mb-2 bg-light text-dark">
        ...
        <div class="p-3 mb-2 bg-success text-white row" id="linhaGreen">.bg-success</div>
        <div class="container">
            <br />
            ...
            <div class="row text-white">
                ...
                <div class="col-sm-8 col-xs-12">
                  <div class="areaBody">
                      ...
                      <div class="shadow-lg p-3 mb-5 bg-primary rounded text-white border border-success text-center" role="alert">
        ...
        <br /><br/><br/><br /><br/>
        <div class="copy">
        <footer class="container shadow-lg p-3 mb-5 bg-white rounded border border-success col-xs-12">
