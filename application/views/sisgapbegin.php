...
<html lang="pt-br">
  ...
  <body class="p-3 mb-2 bg-light text-dark">
        <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
            <img src="http://sisgap.dired.ufla.br/assets/img/sisgap.png" height="20" width="83">
            ...
            <div class="row">
                <div class="col-4">
                    <div class="" style="max-width: 18rem;">
                        <div class="card-header p-3 mb-2 bg-dark text-white"><strong>Já possui Cadastro?</strong>
                            <small><p class="font-italic">Você pode fazer login aqui mesmo, informe seu CPF e sua senha</p></small>
                        </div>
                        <div class="card-body p-3 mb-2 bg-dark text-white">
                            <form>
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><p><strong>Seu CPF</strong></p></label>
                                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="000.000.000-00">
                                    <small id="emailHelp" class="font-italic">CPF válido e que esteje cadastrado no sistema</small><br />
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1"><p><strong>Senha</strong></p></label>
                    ...
                    <div class="" style="max-width: 18rem;">
                        <div class="card-body p-3 mb-2 bg-dark text-white">
                            <p><strong>Se você ainda não possui Cadastro, clique aqui para realizar seu cadastro.</strong></p>
                            <div class="card-body p-3 mb-2 bg-light text-dark">
                                <center><a class="text-primary" href="<?php echo base_url('formulario') ?>"><strong>Quero me cadastrar</strong></a></center>
                            </div>
                            <center><p><strong>Ou entre com</strong></p></center>
                            <div class="card-body p-3 mb-2 bg-light text-dark">
                ...
                <div class="col-8">
                    ...
                    <center><h2 class="p-3 mb-2 bg-dark text-white">Mini tutorial do processo</h2></center>
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                            <img class="d-block w-100" src="<?php echo('assets/img/ajudaEstado1.jpeg') ?>" alt="First slide">
                          </div>
                          <div class="carousel-item">
                            <img class="d-block w-100" src="<?php echo('assets/img/ajudaEstado2.jpeg') ?>" alt="Second slide">
                          </div>
                          <div class="carousel-item">
                            <img class="d-block w-100" src="<?php echo('assets/img/ajudaEstado3.jpeg') ?>" alt="Third slide">
                          </div>
                          <div class="carousel-item">
                            <img class="d-block w-100" src="<?php echo('assets/img/ajudaEstado4.jpeg') ?>" alt="Third slide">
                          </div>
                        </div>
                      ...
                      <br />
                    <div class="alert alert-dark shadow-lg p-3 mb-5 bg-white rounded" role="alert">
                    ...
                    <div class="accordion card" id="accordionExample">
                        <div class="card btn-sm">
                          <div class="card-header p-3 mb-2 bg-dark text-white" id="headingOne">
                            <h5 class="mb-0">
                              <center><button class="btn btn-link p-3 mb-2 bg-dark text-white" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                        ...
                        <div class="card btn-sm">
                          <div class="card-header p-3 mb-2 bg-dark text-white" id="headingTwo">
                            <h5 class="mb-0">
                              <center><button class="btn btn-link collapsed p-3 mb-2 bg-dark text-white" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                        ...
                        <div class="card btn-sm">
                          <div class="card-header p-3 mb-2 bg-dark text-white" id="headingThree">
                            <h5 class="mb-0">
                              <center><button class="btn btn-link collapsed p-3 mb-2 bg-dark text-white" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                Eventos
                              </button></center>
                            </h5>
                          </div>
        ...
        <br /><br />
        <div class="card container p-3 mb-2 bg-light text-dark shadow-lg p-3 mb-5 bg-white rounded">
          <div class="card-header">
            Frase do Dia:
          </div>
          <div class="card-body">
